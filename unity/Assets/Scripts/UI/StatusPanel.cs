...
namespace RcPilot.UI
{
    ...
    public class StatusPanel : MonoBehaviour
    {
        ...
        private static Color StateColor(byte s)
        {
            switch (s)
            {
                case Protocol.STATE_IDLE:    return UiTheme.AccentDim;
                case Protocol.STATE_ARMED:   return UiTheme.Warn;
                case Protocol.STATE_RUNNING: return UiTheme.Good;
                case Protocol.STATE_ESTOP:   return UiTheme.Bad;
                case Protocol.STATE_FAULT:   return UiTheme.Bad;
