...
namespace RcPilot.Assists
{
    ...
    public class AssistController : MonoBehaviour
    {
        ...
        public void SetLevel(AssistLevel lvl)
        {
            ...
            if (_sender != null) _sender.assist = (byte)lvl;
        ...
        private void Update()
        {
            ...
            if (_sender != null)
            {
                _sender.steering = (short)Mathf.RoundToInt(assistedSteer * 10000f);
                _sender.throttle = (short)Mathf.RoundToInt(assistedThr   * 10000f);
                _sender.brake    = (short)Mathf.RoundToInt(assistedBrk   * 10000f);
                _sender.assist   = (byte)level;
            }
        }
        ...
        private void ResetLatched()
        {
            ...
            GovernorActive = false;
            SteerAssist01 = 0f;
            if (_sender != null) _sender.assist = 0;
        }
