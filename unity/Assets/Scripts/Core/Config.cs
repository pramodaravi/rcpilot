...
namespace RcPilot.Core
{
    ...
    {
        // Matches windows/config.yaml → network.jetson_ip etc. from the tele-op stack.
        public string jetsonIp = "10.0.0.50";
        public int controlPort = 7411;
        public int telemetryPort = 7412;
        public int sendHz = 200;
    }

    [Serializable]
    public class VideoConfig
    {
        // The video-bridge/ sidecar decodes RTP H.264 and forwards JPEG frames
        // to the ports below. If the sidecar isn't running the camera planes just
        // show a "NO SIGNAL" static overlay — the rest of the app still works.
        public string bridgeHost = "127.0.0.1";
        public int cam0Port = 9000;
        public int cam1Port = 9001;
